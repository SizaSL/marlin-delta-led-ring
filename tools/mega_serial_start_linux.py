...
try:
        ...
        call(['tools/avrdude_linux', '-V', '-C./tools/avrdude.conf', '-v', '-r', '-patmega328p', '-carduino', port_name, '-b57600', '-Uflash:w:platformio-build/.pioenvs/pro16MHzatmega328/firmware.hex:i'])
